...
m.getSetting = host.device.settings.get
m.putSetting = host.device.settings.put
m.deleteSetting = host.device.settings.delete
m.getProp = host.device.prop.get
m.setProp = host.device.prop.set
m.displayInfo = host.device.display.info
m.setDisplaySize = host.device.display.setSize
m.resetDisplaySize = host.device.display.resetSize
m.setDisplayDensity = host.device.display.setDensity
m.resetDisplayDensity = host.device.display.resetDensity
m.setBrightness = host.device.display.setBrightness
...
m.disableAppComponent = host.app.disableComponent
