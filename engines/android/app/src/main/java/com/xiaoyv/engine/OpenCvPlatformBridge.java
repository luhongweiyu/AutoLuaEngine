...
public final class OpenCvPlatformBridge {
    private static final String CPP_RUNTIME_FILE_NAME =
            "opencv/" + BuildConfig.OPTIONAL_RUNTIME_ABI + "/libc++_shared.so";
    private static final String OPENCV_RUNTIME_FILE_NAME =
            "opencv/" + BuildConfig.OPTIONAL_RUNTIME_ABI + "/libopencv_java4.so";
