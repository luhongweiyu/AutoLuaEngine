...
public final class ScriptHudService extends Service {
    public static final String ACTION_SHOW = "com.xiaoyv.engine.action.SCRIPT_HUD_SHOW";
    public static final String ACTION_UPDATE = "com.xiaoyv.engine.action.SCRIPT_HUD_UPDATE";
    public static final String ACTION_CLOSE = "com.xiaoyv.engine.action.SCRIPT_HUD_CLOSE";
    public static final String ACTION_CLOSE_ALL = "com.xiaoyv.engine.action.SCRIPT_HUD_CLOSE_ALL";
    ...
    private WindowManager.LayoutParams createLayoutParams(JSONObject spec, boolean hasButtons) {
        ...
        int width = spec.has("w")
                ? spec.optInt("w", WindowManager.LayoutParams.WRAP_CONTENT)
                : WindowManager.LayoutParams.WRAP_CONTENT;
        int height = spec.has("h")
                ? spec.optInt("h", WindowManager.LayoutParams.WRAP_CONTENT)
                : WindowManager.LayoutParams.WRAP_CONTENT;
