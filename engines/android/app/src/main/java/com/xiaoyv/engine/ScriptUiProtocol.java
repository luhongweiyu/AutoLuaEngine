...
public final class ScriptUiProtocol {
    public static final String ACTION_CLOSE =
            "com.xiaoyv.engine.action.SCRIPT_UI_CLOSE";
    public static final String ACTION_CLOSE_ALL =
            "com.xiaoyv.engine.action.SCRIPT_UI_CLOSE_ALL";
    public static final String ACTION_WEB_MESSAGE =
            "com.xiaoyv.engine.action.SCRIPT_UI_WEB_MESSAGE";
    ...
    /**
     * 向主进程已有的网页 Activity 广播关闭命令。
     *
     * Dialog 和 HUD 是 WindowManager Service，分别通过显式 Service 命令关闭，避免
     * 广播接收器生命周期与悬浮窗口生命周期相互耦合。
     */
